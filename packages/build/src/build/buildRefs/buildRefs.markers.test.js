...
oops:
  _build.authConfig: authPages.signIn`,
    ...
    expect(context.errors[0].message).toContain(
      '"emailAndPassword.enabled", "magicLink.enabled", "twoFactor.enabled", "passkey.enabled", "phoneNumber.enabled", "phoneNumber.signUpOnVerification", "captcha.enabled", "captcha.provider", "captcha.siteKey", "providers", "organizations.policy", "organizations.signup"'
    );
  });
