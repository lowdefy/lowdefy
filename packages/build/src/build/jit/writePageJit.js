...
async function writePageJit({ page, context }) {
  ...
  // Skipping unchanged content lets the caller avoid touching the CSS
  // recompilation trigger (tailwind-candidates.css) for builds that introduced
  // no new class candidates.
