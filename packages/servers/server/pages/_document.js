      ...
      <Html className="lowdefy">
        <Head>
          ...
          {/* Synchronous pre-hydration script setting the <html> background and
              color-scheme — prevents a mode-mismatch flash of the page and of
              browser chrome (scrollbars, form controls) on page navigation.
              Mirrors useDarkMode.js resolution order:
