...
// Standard dev manager plus the mobile Vite lane, enabled by env flag —
// the manager spawns the mobile client dev server so restarts and shutdown
// ride the existing lifecycle.
async function runMobileDevServer({ context, directory }) {
  await spawnProcess({
    args: ['run', 'start'],
...
export default runMobileDevServer;
