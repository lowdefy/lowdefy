...
test('startUp, options empty', async () => {
  ...
  expect(context).toEqual({
    ...
    directories: {
      ...
      mobile: path.resolve(process.cwd(), './.lowdefy/mobile'),
      mobileProject: path.resolve(process.cwd(), './mobile'),
      server: path.resolve(process.cwd(), './.lowdefy/server'),
    },
    logger,
    lowdefyVersion: 'lowdefyVersion',
    options: { port: 3000, cliConfig: true },
    plugins: undefined,
...
test('startUp, options configDirectory', async () => {
  ...
  expect(context).toEqual({
    ...
    directories: {
      ...
      mobile: path.resolve(process.cwd(), './configDirectory/.lowdefy/mobile'),
      mobileProject: path.resolve(process.cwd(), './configDirectory/mobile'),
