        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose-custom">
            <Section title="Agreement to Terms">
              <p>
                By accessing or using the Lowdefy website at lowdefy.com, documentation at docs.lowdefy.com,
                or any related services (collectively, the &quot;Services&quot;), you agree to be bound by these
                Terms of Service (&quot;Terms&quot;). If you do not agree, please do not use our Services.
              </p>
              <p>
            ...
            <Section title="Open-Source License">
              <p>
                ...
                This license grants you broad rights to use, modify, and distribute the software, subject
                to the conditions of that license.
              </p>
              <p>
                These Terms do not limit or modify the rights granted to you under the Apache License 2.0
                with respect to the open-source code. In the event of a conflict between these Terms and
                the Apache License 2.0 regarding the framework code, the Apache License 2.0 prevails.
              </p>
            </Section>
            ...
            <Section title="Use of Our Services">
              ...
              <ul>
                ...
                <li>Scrape or collect data from the Services in a manner that burdens our infrastructure</li>
            ...
            <Section title="Intellectual Property">
              <p>
                ...
                <a href="https://github.com/lowdefy/lowdefy" target="_blank" rel="noopener noreferrer">
                  GitHub
                </a>.
              </p>
              <p>
                The Lowdefy name, logo, website design, documentation content (excluding code examples),
                and other branding materials are proprietary to Lowdefy, Inc. and are protected by
                intellectual property laws. You may not use our trademarks without prior written permission,
                except as permitted by applicable trademark fair use principles.
              </p>
              <p>
            ...
            <Section title="Community Guidelines">
              <p>
                ...
                <a href="https://github.com/lowdefy/lowdefy/blob/main/CODE_OF_CONDUCT.md" target="_blank" rel="noopener noreferrer">
                  Code of Conduct
                </a>
            ...
            <Section title="Third-Party Services">
              <p>
                ...
                (including GitHub, Discord, and npm). We are not responsible for the content, policies,
                or practices of any third-party services. Your use of such services is governed by their
                respective terms.
              </p>
            </Section>
            ...
            <Section title="Disclaimer of Warranties">
              ...
              <p>
                ...
                any defects will be corrected. The Lowdefy framework is open-source software provided
                under the terms of the Apache License 2.0, which includes its own warranty disclaimers.
              </p>
            </Section>
            ...
            <Section title="Indemnification">
              <p>
                ...
                (including reasonable legal fees) arising out of or related to your use of the Services
            ...
            <Section title="Termination">
              ...
              <p>
                Your rights under the Apache License 2.0 to use the open-source Lowdefy framework code
                are not affected by termination of these Terms.
              </p>
            </Section>
            ...
            <Section title="Governing Law">
              <p>
                ...
                of South Africa, without regard to conflict of law principles. Any disputes arising
                from these Terms shall be resolved in the courts of South Africa.
              </p>
            </Section>
            ...
            <Section title="Changes to These Terms">
              <p>
                ...
                at the top indicates when the Terms were last modified. Your continued use of the
            ...
            <Section title="Contact Us">
              ...
              <ul>
                ...
                <li>
                  GitHub: <a href="https://github.com/lowdefy/lowdefy" target="_blank" rel="noopener noreferrer">github.com/lowdefy/lowdefy</a>
                </li>
              </ul>
            </Section>
          </div>
