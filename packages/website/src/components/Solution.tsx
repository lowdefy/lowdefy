...
import { CheckCircleOutlined, CompressOutlined, SafetyCertificateOutlined, SyncOutlined, LockOutlined } from '@ant-design/icons';
...
const solutions = [
  ...
  },
  {
    ...
    description: 'Every config property is validated against a schema. No room for hidden logic or unexpected behavior.',
  },
  {
    icon: SyncOutlined,
    title: 'One framework update upgrades all your apps',
    description: 'Config is stable. Update Lowdefy once, and every app benefits. No migration scripts needed.',
  },
  {
    icon: LockOutlined,
    title: 'Config is interpreted, not executed. Secure by design',
    description: 'No code injection possible. Auth, permissions, and data validation are built into the runtime.',
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-4 font-mono">
            Config-first: the abstraction layer{' '}
            <span className="text-gradient">AI needs</span>
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
            A declarative config that sits between JavaScript and natural language.
            Constrained enough for guarantees, expressive enough for real apps.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {solutions.map((solution) => (
            ...
            >
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white mb-2">{solution.title}</h3>
