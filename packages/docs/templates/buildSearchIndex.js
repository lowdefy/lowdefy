...
function buildSearchIndex(pages, vars) {
  ...
  const index = {
    ...
    groups: [
      { label: 'Tutorial', match: { section: 'Tutorial' }, icon: 'Rocket' },
      { label: 'Concepts', match: { section: 'Concepts' }, icon: 'Lightbulb' },
      { label: 'Blocks', match: { section: 'Blocks' }, icon: 'PanelsTopLeft' },
      { label: 'Connections', match: { section: 'Connections' }, icon: 'Plug' },
      { label: 'Actions', match: { section: 'Actions' }, icon: 'Zap' },
      { label: 'Operators', match: { section: 'Operators' }, icon: 'SquareFunction' },
      { label: 'Controls', match: { section: 'Controls' }, icon: 'GitBranch' },
    ],
