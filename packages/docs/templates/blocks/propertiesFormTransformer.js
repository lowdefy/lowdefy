  ...
  blocks: [
    {
      ...
      properties: {
        ...
        label: {
          ...
          align: 'right',
          extra:
            'Icon name, such as the semantic name <code>edit</code> or the <a href="https://lucide.dev/icons">Lucide</a> name <code>Pencil</code>, or properties of an Icon block to use as the button icon.',
        },
        showSearch: true,
        allowClear: true,
