...
| `lowdefy_search_icons`           | Search icon names: semantic names first, then Lucide names, then the names of installed icon sets (qualified). Never invent an icon name                                                                               |
