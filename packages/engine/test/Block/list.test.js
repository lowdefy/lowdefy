...
test('list block with init', async () => {
  ...
  const text0 = context._internal.RootSlots.map['list.0.text'];
...
test('list block no init unshift item to start', async () => {
  ...
  const { list, root } = context._internal.RootSlots.map;
  const BlocksContainingList = context._internal.RootSlots.subSlots[root.id][0];
  ...
  expect(context.state).toEqual({ list: [{ text: null }] });
  const text0 = context._internal.RootSlots.map['list.0.text'];
  const ListSubblocks0 = BlocksContainingList.subSlots[list.id][0];
  ...
  const NewListSubblocks0 = BlocksContainingList.subSlots[list.id][0];
  const NewListSubblocks1 = BlocksContainingList.subSlots[list.id][1];
  ...
  const newText0 = context._internal.RootSlots.map['list.0.text'];
...
test('list block no init unshift item to start, block id not in array', async () => {
  ...
  const text0 = context._internal.RootSlots.map['other.0'];
  text0.setValue('first');
  ...
  expect(NewListSubblocks1.arrayIndices).toEqual([1]);
  expect(text0.value).toEqual('first');
  const newText0 = context._internal.RootSlots.map['other.0'];
  expect(newText0.value).toEqual(null);
...
test('list block with rec visible in parent blocks', async () => {
  ...
  const a0 = context._internal.RootSlots.map['list.0.a'];
...
test('primitive list block with init', async () => {
  ...
  const number0 = context._internal.RootSlots.map['list.0'];
...
test('primitive list block with init, push item and setValue', async () => {
  ...
  const a3 = context._internal.RootSlots.map['list.3'];
  a3.setValue(-1);
...
test('list block with nested primitive array with init, push item enforced type on inputs and setValue', async () => {
  ...
  const innerList1 = context._internal.RootSlots.map['list.1.innerList'];
  innerList1.pushItem();
  expect(context.state).toEqual({
    list: [
      { innerList: [true, true, true], text: 'text' },
  ...
  const switch_1_0 = context._internal.RootSlots.map['list.1.innerList.0'];
...
test('list block with nested primitive array with init, push item and setValue', async () => {
  ...
  const number_1_0 = context._internal.RootSlots.map['list.1.innerList.0'];
...
test('list block with init remove item of first item and more than two values', async () => {
  ...
  const blocksContainingList =
    context._internal.RootSlots.subSlots[context._internal.RootSlots.map.root.id][0];
  const listSubblocksList = blocksContainingList.subSlots[list.id];
...
test('list block with init remove item and set existing item values', async () => {
  ...
  const { list } = context._internal.RootSlots.map;
  const text0 = context._internal.RootSlots.map['list.0.text'];
  const text2 = context._internal.RootSlots.map['list.2.text'];
  const blocksContainingList =
    context._internal.RootSlots.subSlots[context._internal.RootSlots.map.root.id][0];
  const listSubblocksList = blocksContainingList.subSlots[list.id];
...
test('primitive list block with init remove item', async () => {
  ...
  const { list } = context._internal.RootSlots.map;
  const num3 = context._internal.RootSlots.map['list.3'];
  const num5 = context._internal.RootSlots.map['list.5'];
  const blocksContainingList =
    context._internal.RootSlots.subSlots[context._internal.RootSlots.map.root.id][0];
  const listSubblocksList = blocksContainingList.subSlots[list.id];
...
test('nested list', async () => {
  ...
  const { list } = context._internal.RootSlots.map;
  const container2 = context._internal.RootSlots.map['list.2.container'];
  const swtch2 = context._internal.RootSlots.map['list.2.swtch'];
  const swtch3 = context._internal.RootSlots.map['list.3.swtch'];
