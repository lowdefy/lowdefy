...
test('_request_details, other context contextId not a string', async () => {
...
test('_request_details, other context contextId not found', async () => {
...
test('_request_details full state', async () => {
