...
test('_input, other context contextId not a string', async () => {
...
test('_input, other context contextId not found', async () => {
...
test('_input param object key', async () => {
  const input = {
    _input: {
      key: 'string',
      contextId: 'other',
...
test('_input replace key arrayIndices', async () => {
...
test('_input param object all', async () => {
  const input = {
    _input: {
      all: true,
      contextId: 'other',
...
test('_input param object all and key', async () => {
  const input = {
    _input: {
      all: true,
      key: 'string',
...
test('_input param object with string default', async () => {
  const input = {
    _input: {
      key: 'notFound',
