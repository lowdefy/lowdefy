...
test('_divide params array with length 3', () => {
  expect(() => divide({ params: [1, 2, 3], location: 'locationId' })).toThrow(
...
test('_divide params array with non numbers', () => {
  expect(() => divide({ params: ['1', 1], location: 'locationId' })).toThrow(
