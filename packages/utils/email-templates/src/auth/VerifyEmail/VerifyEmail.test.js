...
test('VerifyEmail renders to html and text and includes the url', async () => {
...
test('VerifyEmail subject is the expected string', () => {
  expect(VerifyEmail.subject).toEqual('Verify your email address');
});
