...
test('ResetPasswordEmail renders to html and text and includes the url', async () => {
...
test('ResetPasswordEmail subject is the expected string', () => {
  expect(ResetPasswordEmail.subject).toEqual('Reset your password');
});
