...
- id: notif_status_warning
  ...
  properties:
    ...
    description: Server storage is running below 10% capacity.
- id: notif_status_info
  type: Notification
  layout:
    span: 0
  properties:
  ...
  events:
    onClick:
      - id: open_status_error
        type: CallMethod
        params:
          blockId: notif_status_error
          method: open
- id: btn_status_warning
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_status_info
        type: CallMethod
        params:
          blockId: notif_status_info
          method: open
```

```yaml
- id: notif_place_top_right
  type: Notification
  layout:
    span: 0
  properties:
    status: info
    title: Top Right
    description: Default placement position.
    placement: topRight
- id: notif_place_top_left
  type: Notification
  layout:
    span: 0
  properties:
    status: info
    title: Top Left
    description: Appears at the top left corner.
    placement: topLeft
- id: notif_place_bottom_right
  type: Notification
  layout:
    span: 0
  properties:
    status: info
    title: Bottom Right
    description: Appears at the bottom right corner.
    placement: bottomRight
- id: notif_place_bottom_left
  type: Notification
  layout:
    span: 0
  properties:
    status: info
    title: Bottom Left
    description: Appears at the bottom left corner.
    placement: bottomLeft
- id: btn_place_top_right
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_place_top_right
        type: CallMethod
        params:
          blockId: notif_place_top_right
          method: open
- id: btn_place_top_left
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_place_top_left
        type: CallMethod
        params:
          blockId: notif_place_top_left
          method: open
- id: btn_place_bottom_right
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_place_bottom_right
        type: CallMethod
        params:
          blockId: notif_place_bottom_right
          method: open
- id: btn_place_bottom_left
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_place_bottom_left
        type: CallMethod
        params:
          blockId: notif_place_bottom_left
          method: open
```
...
- id: notif_dur_default
  ...
  properties:
    ...
    description: Auto-closes after 4.5 seconds (default).
- id: notif_dur_long
  type: Notification
  layout:
    span: 0
...
- id: notif_dur_sticky
  ...
  properties:
    status: warning
    title: Persistent
    description: Will not auto-close (duration 0). Must be dismissed manually.
    duration: 0
- id: btn_dur_short
  type: Button
  layout:
  ...
  events:
    onClick:
      - id: open_icon_sized
        type: CallMethod
        params:
          blockId: notif_icon_sized
          method: open
```

```yaml
- id: notif_close_icon_string
  type: Notification
  layout:
    span: 0
  properties:
...
- id: btn_close_icon_string
  ...
  events:
    onClick:
      - id: open_close_icon_string
        type: CallMethod
        params:
          blockId: notif_close_icon_string
          method: open
- id: btn_close_icon_styled
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_close_icon_styled
        type: CallMethod
        params:
          blockId: notif_close_icon_styled
          method: open
- id: btn_close_icon_arrow
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_close_icon_arrow
        type: CallMethod
        params:
          blockId: notif_close_icon_arrow
          method: open
```

```yaml
- id: notif_btn_confirm
  type: Notification
  layout:
    span: 0
  properties:
    ...
    description: Please review and confirm the pending changes.
    duration: 0
    button:
      title: Confirm
      icon: AiOutlineCheck
  ...
  events:
    onClick:
      - id: open_btn_confirm
        type: CallMethod
        params:
          blockId: notif_btn_confirm
          method: open
- id: btn_trigger_retry
  type: Button
  layout:
    flex: 0 0 auto
  properties:
...
- id: notif_html_bold
  ...
  properties:
    status: success
    title: <b>Deployment</b> Complete
    description: Deployed to <b>production</b>. Visit <a
      href="https://lowdefy.com">the site</a> to verify.
- id: notif_html_styled
  type: Notification
  layout:
    span: 0
  properties:
    ...
    description: '<span style="color: #fa8c16; font-weight: bold;">Downtime:</span>
      Saturday 2:00 AM - 6:00 AM UTC.'
- id: notif_html_list
  type: Notification
  layout:
    span: 0
  properties:
    status: info
    title: Release Notes
    description: <ul><li>Fixed login timeout issue</li><li>Added dark mode
      support</li><li>Improved dashboard performance</li></ul>
    duration: 0
- id: btn_html_bold
  type: Button
  layout:
  ...
  events:
    onClick:
      - id: open_html_list
        type: CallMethod
        params:
          blockId: notif_html_list
          method: open
```

```yaml
- id: notif_style_border
  type: Notification
  layout:
    span: 0
  properties:
...
- id: notif_style_bg
  ...
  properties:
    ...
    description: This notification has a custom background color.
  style:
    .element:
      background: rgba(250, 173, 20, 0.1)
- id: notif_style_shadow
  type: Notification
  layout:
    span: 0
  properties:
    status: info
    title: Heavy Shadow
    description: This notification has an elevated shadow.
  style:
    .element:
...
- id: btn_style_border
  ...
  events:
    onClick:
      - id: open_style_border
        type: CallMethod
        params:
          blockId: notif_style_border
          method: open
- id: btn_style_bg
  type: Button
  layout:
...
- id: btn_style_shadow
  ...
  events:
    onClick:
      - id: open_style_shadow
        type: CallMethod
        params:
          blockId: notif_style_shadow
          method: open
```

```yaml
- id: notif_override_base
  type: Notification
  layout:
    span: 0
  properties:
  ...
  events:
    onClick:
      - id: open_override_success
        type: CallMethod
        params:
          blockId: notif_override_base
          method: open
          args:
            - status: success
              title: Overridden Title
              description: Status, title, and description overridden at call time.
- id: btn_override_error
  type: Button
  layout:
    flex: 0 0 auto
  properties:
        ...
        params:
          ...
          args:
            - status: error
              ...
              description: This error notification was overridden at call time.
- id: btn_override_duration
  type: Button
  layout:
    flex: 0 0 auto
  properties:
      ...
      - id: open_override_duration
        ...
        params:
          ...
          args:
            - duration: 1
              title: Quick Flash
              description: This closes after just 1 second.
```

```yaml
- id: notif_events_demo
  type: Notification
  layout:
    span: 0
  properties:
    ...
    description: Click the notification body or close it to trigger events.
    duration: 0
  events:
    onClick:
      - id: events_click_msg
        type: DisplayMessage
        params:
          content: Notification body clicked!
          status: info
    onClose:
      - id: events_close_msg
        type: DisplayMessage
        params:
          content: Notification was closed.
          status: success
- id: notif_events_close_action
  type: Notification
  layout:
    span: 0
  properties:
    ...
    description: Your session is about to expire. Close to extend.
    duration: 0
    button:
  ...
  events:
    onClose:
      - id: events_extend_msg
        type: DisplayMessage
        params:
          content: Session extended for 30 minutes.
          status: success
- id: notif_events_click_nav
  type: Notification
  layout:
    span: 0
  properties:
    status: success
    title: New Comment
    description: Click this notification to view the comment.
    duration: 8
  events:
    onClick:
      - id: events_nav_msg
        type: DisplayMessage
        params:
          content: Navigating to comments section...
          status: info
- id: btn_events_demo
  type: Button
  layout:
  ...
  events:
    onClick:
      - id: open_events_demo
        type: CallMethod
        params:
          blockId: notif_events_demo
          method: open
- id: btn_events_close_action
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_events_close
        type: CallMethod
        params:
          blockId: notif_events_close_action
          method: open
- id: btn_events_click_nav
  type: Button
  layout:
    flex: 0 0 auto
  properties:
  ...
  events:
    onClick:
      - id: open_events_click_nav
        type: CallMethod
        params:
          blockId: notif_events_click_nav
          method: open
```

```yaml
- id: notif_css_tailwind
  type: Notification
  layout:
    span: 0
  class: shadow-2xl
  properties:
    ...
    description: This notification uses a Tailwind shadow-2xl class.
- id: notif_css_rounded
  type: Notification
  layout:
    span: 0
  class: rounded-xl
  properties:
    ...
    description: Notification with extra-rounded corners via Tailwind.
- id: notif_css_inline
  type: Notification
  layout:
    span: 0
  ...
  properties:
    status: info
    title: Inline Style
    description: This notification uses inline style with a blue border.
- id: btn_css_tailwind
  type: Button
  layout:
    flex: 0 0 auto
  ...
  events:
    onClick:
      - id: open_css_tailwind
        type: CallMethod
        params:
          blockId: notif_css_tailwind
          method: open
- id: btn_css_rounded
  type: Button
  layout:
          ...
          events:
            onClick:
              - id: order_ship_notif
                type: CallMethod
                params:
                  blockId: notif_order_shipped
                  method: open
```

Monitor system health and receive real-time alerts. Click a button below to simulate different alert types.
...
- id: alerts_card
  ...
  properties:
    ...
    size: small
  blocks:
    - id: alerts_description
      type: Markdown
      properties:
        content: >
          Monitor system health and receive real-time alerts. Click a button
          below to simulate different alert types.
    - id: notif_alert_cpu
      type: Notification
      layout:
        span: 0
      ...
      events:
        onClick:
          - id: alert_cpu_click
            type: DisplayMessage
            params:
              content: Opening server dashboard...
              status: info
    - id: notif_alert_deploy
      type: Notification
      layout:
        span: 0
      properties:
      ...
      events:
        onClose:
          - id: alert_deploy_close
            type: DisplayMessage
            params:
              content: Deployment alert acknowledged.
              status: success
    - id: notif_alert_security
      type: Notification
      layout:
        span: 0
      properties:
          ...
          events:
            onClick:
              - id: trigger_alert_deploy
                type: CallMethod
                params:
                  blockId: notif_alert_deploy
                  method: open
        - id: btn_alert_security
          type: Button
          layout:
            flex: 0 0 auto
          properties:
