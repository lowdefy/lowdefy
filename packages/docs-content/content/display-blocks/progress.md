...
Progress indicator in line, circle, and dashboard styles.
...
- id: strokewidth_thin
  ...
  properties:
    percent: 60
    strokeWidth: 4
- id: strokewidth_default
  type: Progress
  properties:
    percent: 60
- id: strokewidth_thick
  type: Progress
  properties:
    percent: 60
    strokeWidth: 20
- id: strokewidth_circle
  type: Progress
  layout:
    flex: 0 0 auto
  properties:
...
```yaml
- id: theme_default_color
  type: Progress
  properties:
    percent: 70
    theme:
      defaultColor: "#722ed1"
- id: theme_remaining_color
  type: Progress
  properties:
    percent: 55
    theme:
      defaultColor: "#722ed1"
      remainingColor: "#f9f0ff"
- id: theme_circle_text
  type: Progress
  layout:
    flex: 0 0 auto
  properties:
    ...
    percent: 88
    theme:
      circleTextColor: "#1677ff"
      circleTextFontSize: 1.5em
- id: theme_line_border_radius
  type: Progress
  properties:
    percent: 70
    strokeWidth: 16
...
**data-export.csv** - 8.1 MB

**image-corrupted.png** - Upload failed
...
- id: upload_card
  ...
  properties:
    ...
    size: small
  blocks:
    - id: upload_file_1_row
      type: Box
      layout:
        gap: 8
        align: center
      blocks:
        - id: upload_file_1_icon
          type: Icon
          layout:
            flex: 0 0 auto
          properties:
        ...
        - id: upload_file_1_info
          ...
          layout:
            flex: 1 1 auto
          blocks:
            - id: upload_file_1_name
              type: Markdown
              properties:
                content: "**report-q4.pdf** - 2.4 MB"
            - id: upload_file_1_progress
              type: Progress
              properties:
                percent: 100
                status: success
                showInfo: true
    - id: upload_file_2_row
      type: Box
      layout:
        gap: 8
        align: center
      blocks:
        - id: upload_file_2_icon
          type: Icon
          layout:
            flex: 0 0 auto
          properties:
        ...
        - id: upload_file_2_info
          ...
          layout:
            flex: 1 1 auto
          blocks:
            - id: upload_file_2_name
              type: Markdown
              properties:
                content: "**data-export.csv** - 8.1 MB"
            - id: upload_file_2_progress
              type: Progress
              properties:
                percent: 62
                status: active
                strokeColor:
                  0%: "#108ee9"
                  100%: "#87d068"
    - id: upload_file_3_row
      type: Box
      layout:
        gap: 8
        align: center
      blocks:
        - id: upload_file_3_icon
          type: Icon
          layout:
            flex: 0 0 auto
          properties:
        ...
        - id: upload_file_3_info
          ...
          layout:
            flex: 1 1 auto
          blocks:
            - id: upload_file_3_name
              type: Markdown
              properties:
                content: "**image-corrupted.png** - Upload failed"
            - id: upload_file_3_progress
              type: Progress
              properties:
                percent: 35
                status: exception
          ...
          events:
            onClick:
              - id: retry_msg
                type: DisplayMessage
                params:
                  content: Retrying failed upload...
                  status: info
        - id: upload_more_btn
          type: Button
          layout:
      ...
      blocks:
        ...
        - id: onboarding_step_4_label
          ...
          layout:
            flex: 1 1 auto
          properties:
            content: "**Connect workspace**"
        - id: onboarding_step_4_bar
          type: Progress
          layout:
            flex: 0 0 200px
          properties:
          ...
          events:
            onClick:
              - id: skip_msg
                type: DisplayMessage
                params:
                  content: You can complete setup later from your profile.
                  status: info
          ...
          events:
            onClick:
              - id: continue_msg
                type: DisplayMessage
                params:
                  content: Connecting workspace...
                  status: loading
```

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `type` | string | `"line"` | Set type of progress display. Enum: `line`, `circle`, `dashboard`. |
...
| `theme.circleTextColor` | string | `"rgba(0,0,0,0.88)"` | Text color inside the circular progress. |
| `theme.circleTextFontSize` | string | `"1em"` | Font size of text inside the circular progress. |
| `theme.circleIconFontSize` | string | `"1.167em"` | Font size of icons inside the circular progress. |
| `theme.lineBorderRadius` | number | `100` | Border radius of the linear progress bar. |
| `theme.colorSuccess` | string | - | Color used for success status. |
| `theme.colorError` | string | - | Color used for exception status. |
