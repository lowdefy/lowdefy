...
- `logo-dark-theme.png`: A ~250x72px png image used as the header logo for [`PageHeaderMenu`](/PageHeaderMenu) and [`PageSiderMenu`](/PageSiderMenu) blocks on desktop in dark mode.
- `logo-light-theme.png`: A ~250x72px png image used as the header logo for `PageHeaderMenu` and `PageSiderMenu` blocks on desktop in light mode.
- `logo-square-dark-theme.png`: A ~125x125px png image used as the header logo for `PageHeaderMenu` and `PageSiderMenu` blocks on mobile in dark mode.
- `logo-square-light-theme.png`: A ~125x125px png image used as the header logo for `PageHeaderMenu` and `PageSiderMenu` blocks on mobile in light mode.
