...
import fonts, { fonts as namedFonts, fontDescriptors, FONT_FAMILY } from './fonts.js';
...
test('fontDescriptors point pdfmake at absolute paths of files that exist', () => {
  const roles = fontDescriptors.Roboto;
  expect(Object.keys(roles).sort()).toEqual(['bold', 'bolditalics', 'italics', 'normal']);
