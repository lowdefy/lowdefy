              ...
              cell: {
                ...
                properties: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        variant: {
                          ...
                          description:
                            'antd Button variant. Takes precedence over `type` when set.',
                        },
                        color: {
                          type: 'string',
                  ...
                  options: {
                    type: 'array',
                    description:
                      'Selector / Multiple selector cell: dropdown options. An array of primitives, or objects mirroring the `Selector` block options: `{ label, value, disabled, color, filterString, style }`. `label` supports html.',
                  },
                  valueKey: {
                    type: 'string',
                    description:
                      'Selector / Multiple selector: field on each option object to use as its value. Defaults to `value`.',
                  },
                  primaryKey: {
                    type: 'string',
                    description:
                      'Selector / Multiple selector: field used to match the cell value to an option (identity key for object values).',
                  },
                  eventName: {
                    type: 'string',
                    description:
                      'Selector / Multiple selector: block-level event triggered on change. Event payload is `{ row, value, newValue }` (`newValue` is an array for `multipleSelector`).',
                  },
                  placeholder: {
                    type: 'string',
                  ...
                  size: {
                    ...
                    default: 'small',
                    description:
                      'Selector / Multiple selector: input size. Defaults to `small` inside cells.',
                  },
                  disabled: {
                    type: 'boolean',
                    default: false,
                  ...
                  variant: {
                    type: 'string',
                    enum: ['outlined', 'filled', 'borderless', 'solid'],
                    description:
                      'Selector / Multiple selector: visual variant. `solid` fills the control (single) or tags (multiple) with the selected option colour.',
                  },
                  bordered: {
                    type: 'boolean',
                    description:
                      'Selector / Multiple selector: set false for a borderless control. Deprecated alias of `variant: borderless`.',
                  },
                  showArrow: {
                    type: 'boolean',
                  ...
                  maxTagCount: {
                    type: ['number', 'string'],
                    description:
                      'Multiple selector: max tags shown before collapsing (a number, or "responsive").',
                  },
