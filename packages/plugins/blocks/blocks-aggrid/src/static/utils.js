...
/**
 * Shared helpers for the AgGrid `./static` report renderer.
 *
 ...
 *
 * This entry must also stay free of ag-grid and React so the server can load
 * the registry without a browser runtime.
 */
