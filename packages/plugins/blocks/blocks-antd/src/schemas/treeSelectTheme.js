...
export default {
  ...
  properties: {
    ...
    activeBorderColor: { type: 'string', description: 'Border color when active/focused.' },
    activeOutlineColor: { type: 'string', description: 'Outline color when active/focused.' },
    optionSelectedBg: { type: 'string', description: 'Background of selected option.' },
    optionSelectedColor: { type: 'string', description: 'Text color of selected option.' },
    optionSelectedFontWeight: { type: 'string', description: 'Font weight of selected option.' },
    optionActiveBg: { type: 'string', description: 'Background of active (hovered) option.' },
    optionFontSize: { type: 'number', default: 14, description: 'Font size of options.' },
    optionHeight: { type: 'number', default: 32, description: 'Height of each option.' },
    optionLineHeight: { type: 'string', description: 'Line height of options.' },
    optionPadding: { type: 'string', description: 'Padding of options.' },
