  ...
  properties: {
    ...
    properties: {
      ...
      suffixIcon: {
        ...
        description:
          "Icon name (a semantic name like edit, or a <a href='https://react-icons.github.io/react-icons/'>React Icons</a> name like LuPencil) or properties of an Icon block to customize icon at the right-hand side of the date picker.",
      },
      title: inputTitle,
      theme: {
        type: 'object',
