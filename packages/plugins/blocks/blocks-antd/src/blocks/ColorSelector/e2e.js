...
export default createBlockHelper({
  ...
  expect: {
    panelVisible: (page, _blockId) =>
      expect(page.locator('.ant-color-picker .ant-color-picker-inner')).toBeVisible(),
    panelHidden: (page, _blockId) =>
      expect(page.locator('.ant-color-picker .ant-color-picker-inner')).toBeHidden(),
    disabled: (page, blockId) =>
      expect(locator(page, blockId)).toHaveClass(/ant-color-picker-disabled/),
  },
});
