...
export default createBlockHelper({
  ...
  do: {
    ...
    clickItem: (_page, _blockId, title) =>
      _page.locator(`.ant-dropdown-menu-item:has-text("${title}")`).click(),
    clickSplitArrow: (page, blockId) =>
      locator(page, blockId).locator('.ant-space-compact button').last().click(),
  },
  expect: {
    ...
    text: (page, blockId, text) =>
      expect(locator(page, blockId).locator('button').first()).toHaveText(text),
  },
});
