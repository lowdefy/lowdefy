...
test('no renderer file imports React, echarts-for-react, or a block component', () => {
  const files = fs
...
test('the static entry imports echarts', () => {
  const source = fs.readFileSync(path.join(STATIC_DIR, 'EChart.js'), 'utf8');
