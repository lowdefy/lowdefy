...
export default {
  ...
  events: {
    onChange: 'Trigger actions when the switch is toggled.',
  },
  properties: {
    type: 'object',
    ...
    properties: {
      checkedText: {
        type: 'string',
        description: 'Text shown when the switch is checked.',
      },
      disabled: {
        type: 'boolean',
        description: 'Disable the switch if true.',
        default: false,
      },
      label: {
        type: 'object',
      ...
      uncheckedText: {
        type: 'string',
        description: 'Text shown when the switch is unchecked.',
      },
    },
  },
};
