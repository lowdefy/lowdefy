  ...
  properties: {
    ...
    properties: {
      html: {
        type: 'string',
        description:
          'Content to be rendered as Html. The Html block attributes (data-icon, data-tooltip, data-popover, data-page-id links, data-new-tab, data-tag, data-status, data-time, data-format, data-avatar, data-copy) work here too, unless DOMPurifyOptions removes data attributes.',
        docs: {
