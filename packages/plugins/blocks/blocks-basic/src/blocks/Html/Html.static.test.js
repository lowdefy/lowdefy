...
// Test-only import of the report fonts from the reports plugin source (Roboto
// buffers the Html renderer registers with takumi). This is a dev/test relative
// import, not a package dependency — blocks-basic stays decoupled from the
// reports plugin at runtime; the renderer takes fonts via `context.fonts`.
import fonts from '../../../../../plugins/plugin-reports/src/fonts/fonts.js';
