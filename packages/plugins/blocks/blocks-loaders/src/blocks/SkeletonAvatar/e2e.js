...
const locator = (page, blockId) => page.locator(`#bl-${escapeId(blockId)} .skeleton`);
...
export default createBlockHelper({
  ...
  expect: {
    ...
    borderRadius: (page, blockId, radius) =>
      expect(locator(page, blockId)).toHaveCSS('border-radius', radius),
  },
});
