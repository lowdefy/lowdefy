...
const authConfig = {
  ...
  twoFactor: { enabled: true, required: true, trustDevice: false },
...
test('_authConfig returns twoFactor.trustDevice boolean', () => {
  expect(_authConfig({ authConfig, params: 'twoFactor.trustDevice' })).toBe(false);
});
