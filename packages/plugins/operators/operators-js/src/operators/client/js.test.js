...
test('js calls a module export bound to a hash with the client prototype and args', () => {
  function buildRows({ args, actions }) {
    return { docs: args.docs, hasPrototype: typeof actions === 'function' };
  }
